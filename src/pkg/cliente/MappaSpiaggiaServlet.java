...
public class MappaSpiaggiaServlet extends HttpServlet {
	...
	//	Ombrellone[] mappaSpiaggiaOmbrelloni=new Ombrellone[24];
		...
		for(int i=1; i<8; i++){ // la lista deglio ombrelloni è di 24
		...
		for(Ombrellone ombrellone : listaOmbrelloni)
			   System.out.println(ombrellone.getId_ombrellone()+" lettini: "+ombrellone.getNum_lettini()+" zona: "+ombrellone.getZona());
		
		  if(listaOmbrelloni.isEmpty()) { String address="/jsp_result/registrazione_failed.jsp";
